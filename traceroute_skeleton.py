...
class TracerouteNoRoot:
    ...
    def send_probe(self, ttl):
        ...
        try:
            ...
            #socket.IPPROTO_IP is a constant that indicates which protocol layer the option belongs to
            ...
            try:
                ...
                for cmsg_level, cmsg_type, cmsg_data in ancdata:
                    ...
                    if cmsg_level == socket.IPPROTO_IP and cmsg_type == IP_RECVERR:
                        ...
                        if len(sockaddr) == 8:
                            sin_family, sin_port, raw_ip = struct.unpack("!HHI", sockaddr)
                            error_addr = socket.inet_ntoa(struct.pack("!I", raw_ip))
